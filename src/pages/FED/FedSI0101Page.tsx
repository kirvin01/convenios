// src/components/FedSI0101Page.tsx
...
import {
  ...
  type ResumenRow,
} from '../../services/servicesFED/fedSI0101Service';
...
export function FedSI0101Page() {
  ...
  useEffect(() => {
    ...
    fedSI0101Service.getFiltros(ctrl.signal)
      .then((data) => {
        setFiltros(data);
  ...
  const cargarTablaCompleta = useCallback((signal?: AbortSignal) => {
    ...
    fedSI0101Service.getTablaCompleta(
  ...
  const cargarTablaRedes = useCallback((signal?: AbortSignal) => {
    ...
    setLoadingTabla(true);
    setNotification(null);
    fedSI0101Service.getTablaRedes(
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 3, mb: 4 }}>
      ...
      <Box display="flex" alignItems="center" gap={1.5} mb={1}>
        ...
        <Box>
          <Typography variant="h4" fontWeight={700}>FED SI-01.01</Typography>
      ...
      {!mes ? (
        ...
        >
          <LocalHospitalIcon sx={{ fontSize: 52, color: alpha('#1565C0', 0.2), mb: 1 }} />
