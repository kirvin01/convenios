// src/components/FedSI0202Page.tsx
...
import {
  ...
  type ResumenRow,
} from '../../services/servicesFED/fedSI0202Service.ts';
...
export function FedSI0202Page() {
  ...
  useEffect(() => {
    ...
    fedSI0202Service.getFiltros(ctrl.signal)
      .then((data) => {
        setFiltros(data);
  ...
  const cargarTablaCompleta = useCallback((signal?: AbortSignal) => {
    ...
    fedSI0202Service.getTablaCompleta(
  ...
  const cargarTablaRedes = useCallback((signal?: AbortSignal) => {
    ...
    setLoadingTabla(true);
    setNotification(null);
    fedSI0202Service.getTablaRedes(
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 3, mb: 4 }}>
      ...
      <Box display="flex" alignItems="center" gap={1.5} mb={1}>
        ...
        <Box>
          <Typography variant="h4" fontWeight={700}>FED SI-02.02</Typography>
          <Typography color="text.secondary">
            [Descripción del reporte FED SI-02.02]
          </Typography>
        </Box>
      </Box>
      <Divider sx={{ mb: 3 }} />
