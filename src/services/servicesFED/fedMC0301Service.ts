// src/services/servicesFED/fedMC0301Service.ts
// Servicio para el reporte FED MC-03.01 — igual patrón que MC-01.01

import { API_CONFIG } from '../../config';
import { authHeader } from '../authService';

const BASE = `${API_CONFIG.baseURL}/fed/mc0301`;
